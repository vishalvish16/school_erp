...
// PURPOSE: Driver login — email/password + school selection (mobile).
// =============================================================================
  ...
  Widget build(BuildContext context) {
    ref.listen<SchoolStaffLoginState>(schoolStaffLoginProvider, (prev, next) {
      ...
      if (next.requiresOtp &&
        ...
        final q =
            'otp_session_id=${next.otpSessionId!}&masked_phone=${Uri.encodeComponent(next.maskedPhone ?? '')}&masked_email=${Uri.encodeComponent(next.maskedEmail ?? '')}&otp_sent_to=${Uri.encodeComponent(next.otpSentTo ?? '')}&portal_type=driver${next.devOtp != null ? '&dev_otp=${next.devOtp}' : ''}';
      ...
      if (next.requires2fa &&
        ...
        final q =
            'temp_token=${Uri.encodeComponent(next.tempToken!)}&portal_type=driver';
                ...
                children: [
                  if (_errorMessage != null)
                    Padding(
                      ...
                      child: Text(
                        _errorMessage!,
                        style: AppTextStyles.bodySm(color: AppColors.error700),
                      ),
                    ),
                  _buildLoginCard(),
                ],
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        filter: ImageFilter.blur(
            sigmaX: AuthSizes.glassBlur, sigmaY: AuthSizes.glassBlur),
        child: Container(
                  ...
                  TextFormField(
                    ...
                    validator: (v) =>
                        v == null || v.trim().isEmpty
                            ? AppStrings.enterEmailOrMobileError
                            : null,
                  ),
                  AppSpacing.vGapLg,
                  TextFormField(
                  ...
                  Align(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        ...
                        style: AuthTextStyles.forgotPassword,
                      ),
                    ),
                  ),
                  Text(

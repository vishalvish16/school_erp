// =============================================================================
// FILE: lib/features/auth/school_admin_login_screen.dart
// PURPOSE: School Admin / Principal login — {schoolslug}.vidyron.in
// =============================================================================
...
class SchoolAdminLoginScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SchoolAdminLoginScreen> createState() => _SchoolAdminLoginScreenState();
}

class _SchoolAdminLoginScreenState extends ConsumerState<SchoolAdminLoginScreen>

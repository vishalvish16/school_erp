// =============================================================================
// FILE: lib/features/auth/teacher_login_screen.dart
// PURPOSE: Teacher portal login — school pick + password (route /login/teacher).
// =============================================================================
  ...
  Widget build(BuildContext context) {
    ref.listen<SchoolStaffLoginState>(schoolStaffLoginProvider, (prev, next) {
      ...
      if (next.requiresOtp &&
        ...
        final q =
            'otp_session_id=${next.otpSessionId!}&masked_phone=${Uri.encodeComponent(next.maskedPhone ?? '')}&masked_email=${Uri.encodeComponent(next.maskedEmail ?? '')}&otp_sent_to=${Uri.encodeComponent(next.otpSentTo ?? '')}&portal_type=teacher${next.devOtp != null ? '&dev_otp=${next.devOtp}' : ''}';
      ...
      if (next.requires2fa &&
        ...
        final q = 'temp_token=${Uri.encodeComponent(next.tempToken!)}&portal_type=teacher';

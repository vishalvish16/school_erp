// =============================================================================
// FILE: lib/features/parent/presentation/screens/parent_change_password_screen.dart
// PURPOSE: Change password screen for the Parent portal.
// =============================================================================
...
class _ParentChangePasswordScreenState
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (v) {
                              if (v == null || v.isEmpty) {
                                return AppStrings.fieldRequired(AppStrings.newPassword);
                              }
                          ...
                          TextFormField(
                            ...
                            validator: (v) {
                              if (v == null || v.isEmpty) {
                                return AppStrings.fieldRequired(AppStrings.confirmPassword);
                              }
                              if (v != _newCtrl.text) {
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(parentServiceProvider).changePassword(

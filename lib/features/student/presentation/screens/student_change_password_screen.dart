// =============================================================================
// FILE: lib/features/student/presentation/screens/student_change_password_screen.dart
// PURPOSE: Change password screen for the Student portal.
// =============================================================================
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (v) {
                              if (v == null || v.isEmpty) {
                                return AppStrings.confirmNewPassword;
                              }
                              if (v != _newCtrl.text) {

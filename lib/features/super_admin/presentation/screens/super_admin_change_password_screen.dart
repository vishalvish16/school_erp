// =============================================================================
// FILE: lib/features/super_admin/presentation/screens/super_admin_change_password_screen.dart
// PURPOSE: Change password for super admin (current + new password)
// =============================================================================
...
class SuperAdminChangePasswordScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SuperAdminChangePasswordScreen> createState() =>
      _SuperAdminChangePasswordScreenState();
}

class _SuperAdminChangePasswordScreenState
    extends ConsumerState<SuperAdminChangePasswordScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      await ref.read(superAdminServiceProvider).changePassword(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (v) {
                        if (v == null || v.trim().isEmpty) return AppStrings.currentPasswordRequired;
                        return null;
                      },
                    ),
                    AppSpacing.vGapLg,
                    TextFormField(
                      ...
                      validator: (v) {
                        if (v == null || v.trim().isEmpty) return AuthStrings.passwordRequired;
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: _saving ? null : () => _currentController.clear(),
